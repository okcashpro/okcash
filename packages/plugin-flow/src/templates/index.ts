...
- Field "token": Cadence Resource Identifier or ERC20 contract address (if not native token). this field should be null if the token is native token: $FLOW. Examples for this information:
    1. For Cadence resource identifier, the field should be "A.1654653399040a61.FlowToken.Vault"
...
- Field "to": Recipient wallet address, can be EVM address or Cadence address. Examples for this information:
