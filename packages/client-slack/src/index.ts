...
export class SlackClient extends EventEmitter {
    ...
    constructor(runtime: IAgentRuntime) {
        ...
        if (!this.signingSecret) throw new Error("SLACK_SIGNING_SECRET is required");
    ...
    async start() {
        try {
            ...
            this.server.post('/slack/events', async (req: SlackRequest, res) => {
                try {
            ...
            this.server.post('/slack/interactions', async (req: SlackRequest, res) => {
                try {
