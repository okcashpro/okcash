...
import { ActionExample, Message, Provider, State } from "../core/types.ts";
...
const excerptConversations: ActionExample[][] = [
  [
    ...
    },
    {
      ...
      content: {
        content:
          "Right. Themed lunches. On Mexican Day they set up a taco bar. Italian Day is spaghetti and meatballs.",
        action: "WAIT",
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        content:
          "We have a variety of extracurriculars. Soccer, drama, cheerleading.",
        action: "WAIT",
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        content:
          "Fast-pitch softball is a big deal here. Some kids are trying to start an organic gardening club. I don't know what you were accustomed to doing in California.",
        action: "WAIT",
      },
    },
    {
  ...
  [
    ...
    },
    {
      ...
      content: {
        content:
          "Please work. Please be a way out. Come on, come on, come on. Move!",
        action: "WAIT",
      },
    },
    {
  ...
  [
    ...
    },
    {
      ...
      content: {
        content:
          "What happened? Your hair, Ruby. And why are you wearing those glasses?",
        action: "WAIT",
      },
    },
    {
  ...
  [
    ...
    },
    {
      ...
      content: {
        content:
          "I understand that this has been difficult for everyone. I apologize for the hurt, Ruby, but you know that your mother and I have been heading in different directions for some time. I love Willow, and my hope is that we can all move forward with forgiveness and acceptance. Dad.",
        action: "WAIT",
      },
    },
    {
  ...
  [
    ...
    },
    {
      ...
      content: {
        content:
          "Because I'm your big brother, and I'm in charge, and you've been missing for hours. Because the divorce is making us both crazy, and it's my job to take care of you, to get us through all this.",
        action: "WAIT",
      },
    },
  ],
  [
    ...
    },
    {
      ...
      content: {
        content:
          "We should take you back to the hospital for X-rays. If it's a fracture, it's not going to feel better tomorrow.",
        action: "WAIT",
      },
    },
    {
  ...
  [
    ...
    },
    {
      ...
      content: {
        content:
          "You're from French class, right? I'm George Pierce. You wanna sit down a minute? You look pale.",
        action: "WAIT",
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        content:
          "I don't know. It's weird. Something from a reoccurring dream.",
        action: "WAIT",
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        content:
          "Really? You know that for sure? I've never been to California.",
        action: "WAIT",
      },
    },
    {
  ...
  [
    ...
    },
    {
      ...
      content: {
        content:
          "The Peking duck is awesome, so is the barbeque assortment platter.",
        action: "ELABORATE",
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        content:
          "We have a bunch of mutual friends on social media? I, um, read some of your posts. You know, just clicking around.",
        action: "WAIT",
      },
    },
  ],
  [
    ...
    },
    {
      ...
      content: {
        content:
          "Oh, Ruby. Don't worry. We've got all your info in here. I'll just pull you up.",
        action: "WAIT",
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        content:
          "I talked to your mom today. Seems like she's doing okay. What a rough breakup. So sad. Do you like her new apartment? It must be hard on you. My parents got divorced when I was ten. I remember how confused I was.",
        action: "WAIT",
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        content:
          "What's wrong? I really need to get going. I'm--uh--late for--",
        action: "WAIT",
      },
    },
    {
      ...
      content: {
        content:
          "Looks like you overpaid on a late fee, honey. We owe you two dollars. Sorry about that.",
        action: "WAIT",
      },
    },
    {
  ...
  [
    {
      ...
      content: {
        content:
          "The smallest, cheapest version of coffee you make, and one of those tiny cranberry-walnut mini-scones, please.",
        action: "WAIT",
      },
    },
    {
      ...
      content: {
        content:
          "What? You don't even say hello? Cool haircut. So where's Patrick?",
        action: "WAIT",
      },
    },
  ],
  [
    {
      ...
      content: {
        content:
          "You okay? You're heading the wrong direction, you know. The school's that way.",
        action: "WAIT",
      },
    },
    {
      ...
      content: {
        content:
          "I--uh, I forgot something in my mom's car. I wish I could stay, George. I really gotta get going.",
        action: "WAIT",
      },
    },
    {
    ...
    },
    {
      ...
      content: {
        content:
          "If anyone ever takes it apart again and makes it into a fugly house, you can fix it.",
        action: "WAIT",
      },
    },
    {
      ...
      content: {
        content:
          "Do me a favor, okay? Later today, soon, I think--I really hope--the old Ruby is going to be back. I'm not sure where she is at this moment, but I'm wishing and expecting that she's okay, and she'll be home when I leave.",
        action: "WAIT",
      },
    },
  ],
...
export const composeActionExamples = (
  ...
  const formattedExamples = randomMessageExamples.map((example) => {
    return `\n${example
      .map((message) => {
        const messageString = `${message.user}: ${message.content.content}${message.content.action ? ` (${message.content.action})` : ""}`;
