...
#if defined(OKCASH_NEED_QT_PLUGINS) && !defined(_OKCASH_QT_PLUGINS_INCLUDED)
#define _OKCASH_NEED_QT_PLUGINS
#define __INSURE__
#include <QtPlugin>
...
int main(int argc, char *argv[])
{
    ...
    // Load e.g. bitcoin_de.qm (shortcut "de" needs to be defined in okcash.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        app.installTranslator(&translatorBase);

    // Load e.g. bitcoin_de_DE.qm (shortcut "de_DE" needs to be defined in okcash.qrc)
