...
- Tommy: Podcast host
- Shaw: Founder of AI16z, creator of the OKai agent framework
...
1. **Explosive Growth and Innovation**: Rapid development with numerous open-source projects pushing boundaries. Example: AI16z's OKai framework with 80+ contributors.
...
- **Shaw (AI16z)**: Founder of AI16z and creator of the OKai framework.
