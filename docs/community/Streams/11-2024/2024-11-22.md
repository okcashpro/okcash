...
The format is open to everyone in the AI agent community, not just those directly affiliated with ai16zdao. Many developers and teams working with the OKai framework, an open-source platform for building social AI agents, showcased their projects.
