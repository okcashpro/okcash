#!/bin/bash
# Do "chmod +x INSTALL_ubuntu20_GUI.sh" if you can't run this file"
echo "Compiling|Installing - "okcash GUI" to Ubuntu 20.04"
date

# Call INSTALL_ubuntu20_node compilation
cd oktools/ubuntu20
chmod +x *
/bin/bash ./Compile_ubuntu20_GUI.sh
...
# end Client
echo "Done with the Okcash GUI for Ubuntu 20 install on its latest version for:"
uname -a
echo "  "
