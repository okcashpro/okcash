...
2. **Environment Variables - NOT REQUIRED** : Set up a `.env` file in the project root (okai) with the necessary environment variables. Copy .env.example file and add required variables.
