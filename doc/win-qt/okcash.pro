...
CONFIG += static
LIBS += -L"c:/deps/openssl-1.0.1l" -llibeay32
...
build_win32 {
    ...
    OPENSSL_LIB_PATH=c:/deps/openssl_1.0.1l
...
# Set libraries and includes at end, to use platform-defined defaults if not over ridden
